...
import { RadarIcon, LightningIcon } from "@/components/icons";
  ...
  return (
    <div className="min-h-screen bg-[#030712] flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        {/* Access Badge */}
        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#0047AB]/10 border border-[#0047AB]/30 mb-6 backdrop-blur-sm">
          <LightningIcon className="w-4 h-4 text-[#82C8E5]" />
          <span className="text-sm font-medium text-[#82C8E5]">
